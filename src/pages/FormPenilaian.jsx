...
export default function FormPenilaian() {
  ...
  const komponen = [
    ...
    {
      id: "k4",
      label: "Keputusan Klinik / Diagnosis",
      bobot: 10,
      poin: [
        "Mampu membuat diagnosis terhadap kondisi pasien saat ini",
        "Mampu memberikan Differential Diagnosis terkait kondisi pasien saat ini",
      ],
    },
    { id: "k5", label: "Kemampuan Mengusulkan Pemeriksaan Penunjang", bobot: 5, poin: [
      "Mempertimbangkan  indikasi dalam pemilihan  pemeriksaan penunjang",
      "Mempertimbangkan  manfaat dan resiko  pemeriksaan penunjang",
      "Menerapkan konsep cost  effective dalam memilih",
    ] },
    { id: "k6", label: "Kemampuan Merencanakan Pengelolaan Pasien", bobot: 10, poin: [
      "Mampu melakukan  pemilihan terapi yang  diberikan kepada pasien  dengan mempertimbangkan  manfaat dan resiko terapi,  interaksi obat yang  mungkin terjadi",
      "Mampu melakukan  pemilihan terapi non  farmakologis yang sesuai  dengan kondisi yang  dialami pasien",
      "Memperhatikan kondisi  sosial dan ekonomi pasien  dalam merencanakan  pengelolaan pasien",
    ] },
    { id: "k7", label: "Kemampuan Konseling", bobot: 10, poin: [
      "Menjelaskan alasan/ dasar  pemeriksaan dan terapi  kepada pasien/ keluarga  pasien",
      "Memperoleh persetujuan  tindakan medik (informed  consent)/ tatalaksana  lanjutan, bila diperlukan  kepada pasien/ keluarga  pasien",
      "Memberi edukasi tentang  penatalaksanaan,  pencegahan dan konseling  lain yang terkait dengan  penyakitnya",
    ] },
    { id: "k8", label: "Organisasi / Efisiensi", bobot: 10, poin: [
      "Peserta didik mampu menentukan prioritas, dan menyesuaikan dengan  waktu yang tersedia",
    ] },
    { id: "k9", label: "Kualitas Humanistik / Profesionalisme", bobot: 10, poin: [
      "Menghargai pasien,  menunjukkan empati, belas  kasih dan menciptakan  kepercayaan antara dokter pasien",
      "Membantu agar pasien  merasa nyaman dan  memperhatikan kaidah  kesopanan dalam setiap  tahap tindakan serta bisa  menjaga kerahasiaan  pasien",
      "Memberikan informasi  secara jelas terkait kondisi  pasien saat ini",
      "Menyadari keterbatasan  yang dimiliki dan  menentukan indikasi rujuk  jika diperlukan",
    ] },
    { id: "k10", label: "Kompetensi Klinik Keseluruhan", bobot: 10, poin: [
      "Penilaian keseluruhan terhadap performance Dokter Muda",
    ] },
  ];
